...
namespace KProjectConverter
{
  ...
  {
    public static void BuildGlobalJson(List<CSProject> projects, string rootDirPath)
    {
    ...
    private static string[] FindProjectPaths(List<CSProject> projects, string rootDirPath)
    {
